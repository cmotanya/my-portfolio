...
const Testimonial = () => {
  ...
  return (
    <div
      ref={carouselRef}
      className="relative py-8 w-full md:mt-10 md:max-w-3xl"
    >
          ...
          {[-1, 0, 1].map((offset) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "relative mx-auto mt-10 flex w-full transform flex-col items-center gap-1 rounded-md border-2 border-secondary bg-white p-3 pt-[2.5rem] shadow-xl",
